...
(crude) Power analysis for future intervention studies below (April 23, 2018):

```{r}
eff_size <- coefficients(fit_lm)/sigma(fit_lm)

power.t.test(delta = eff_size[4], power = .80)
```
