...
```{r}
summary(fit_brm_ord2_intent)
gg_marginal_effects(fit_brm_ord2_intent, "time:condition") %>% plot()
```
...
fit_brm_beta2_resp_intent <- brm(
  ...
  cores = parallel::detectCores(),
  iter = 2000,
  save_model="fit_brm_beta2_resp_intent"
)
```

```{r}
summary(fit_brm_beta2_resp_intent)
gg_marginal_effects(fit_brm_beta2_resp_intent, "phase:condition") %>% plot()
```
